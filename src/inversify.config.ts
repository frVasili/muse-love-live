...
import OfficialSoundCloudResolver from './services/official-soundcloud-resolver.js';
import SoundCloudResolver from './services/soundcloud-resolver.js';
...
container.bind<OfficialSoundCloudResolver>(TYPES.Services.OfficialSoundCloudResolver).to(OfficialSoundCloudResolver).inSingletonScope();
container.bind<SoundCloudResolver>(TYPES.Services.SoundCloudResolver).toConstantValue(new SoundCloudResolver());
